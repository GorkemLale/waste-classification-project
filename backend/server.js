...
app.get('/api/waste-types', (req, res) => {
  res.json({
    success: true,
    data: [
      { type: 'paper', name: 'Kağıt', color: 'blue', binColor: 'Mavi' },
      { type: 'glass', name: 'Cam', color: 'green', binColor: 'Yeşil' },
      { type: 'metal', name: 'Metal', color: 'gray', binColor: 'Gri' },
      { type: 'organic', name: 'Organik', color: 'brown', binColor: 'Kahverengi' },
      { type: 'plastic', name: 'Plastik', color: 'yellow', binColor: 'Sarı' }
    ]
  });
});
